...
import com.hsr2024.tf01flowerimageclassification.ml.EyeModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickBtn(){
        ...
        //# 1. 모델 객체 생성
        val model: EyeModel = EyeModel.newInstance(this)
        ...
        //#3. 추론작업 시작 -- 동기식 방식
        val outputs: EyeModel.Outputs = model.process(image)
